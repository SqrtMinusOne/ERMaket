...
from ermaket import create_app
...
from ermaket.api.models import Faker, Models, Seeder
from ermaket.api.system import (HierachyConstructor, HierachyManager,
                                UserManager)
...
def set_temp_paths(config):
    ...
    config.Generation['base'] = 'ermaket._temp.base'
