...
from ermaket.api.erd.er_entities import Attribute, Entity, Relation
from ermaket.api.erd.rd_entities import Column, ForeignKey, ORMRelationship, Table
...
class Factory:
    ...
    def secondary_link(
        ...
        [setattr(r1, 'ref_rel', r2) for r1, r2 in combinations(rels, 2)]
        return linked
